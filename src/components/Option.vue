            ...
            <div slot="body">
                <div class="container">
                    <div class="card-deck">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="aligner"><h4 class="card-text mx-3">COLOUR</h4></div>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="aligner"><h4 class="card-text mx-3">LANGUAGE</h4></div>
...
export default {
    ...
    methods: vuex.mapActions(['setIsDraggingMenu'])
}
</script>
